...
const config = {
  SESSION_ID: process.env.SESSION_ID || "https://gist.github.com/AbhishekSuresh2/705d850afc415d54fdeac311f5981aea/raw",
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "50935327850@s.whatsapp.net",
  OWNER_NAME: process.env.OWNER_NAME || "INCONNU Baby",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "50935327850",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "50935327850",
